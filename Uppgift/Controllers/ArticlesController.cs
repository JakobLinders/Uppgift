...
namespace Uppgift.Controllers
{
    ...
    {
        private readonly UppgiftContext _context;

        public ArticlesController(UppgiftContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ArticleNum,Description,Price,PriceVAT")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ArticleNum,Description,Price,PriceVAT")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
